...
import { MapPin, Calendar, Sun, Droplets, Award, Share2, ArrowLeft, ShieldCheck, Leaf, Wind, Loader2 } from 'lucide-react';
               ...
               <div className="relative pl-10 group">
                  ...
                  <div className="bg-white rounded-3xl p-5 border border-gray-100 shadow-xl transition-all hover:scale-[1.02]">
                     ...
                     <div className="h-40 w-full rounded-2xl overflow-hidden relative z-0 border border-gray-100 shadow-inner">
                        ...
                        <Suspense fallback={<div className="w-full h-full flex items-center justify-center bg-gray-50"><Loader2 className="animate-spin text-agro-green" size={24} /></div>}>
                           <AgroMap3D
                              initialViewState={{
