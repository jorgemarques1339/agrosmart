...
const AnimalDetailsModal: React.FC<AnimalDetailsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[160] flex items-end md:items-center justify-center bg-black/70 backdrop-blur-md animate-fade-in p-0 md:p-6" onClick={onClose}>
      <div 
        className="bg-[#FDFDF5] dark:bg-[#0A0A0A] w-full md:max-w-3xl h-[95vh] md:h-auto md:max-h-[90vh] rounded-t-[2.5rem] md:rounded-[3rem] shadow-2xl flex flex-col overflow-hidden relative border-t border-white/20 md:border md:border-white/10 transition-all"
      ...
      >
        ...
        <div className="px-6 py-5 border-b border-gray-100 dark:border-neutral-800 bg-white/80 dark:bg-[#0A0A0A]/80 backdrop-blur-xl sticky top-0 z-20 shrink-0">
           ...
           <div className="md:hidden w-12 h-1.5 bg-gray-200 dark:bg-neutral-800 rounded-full mx-auto mb-6 opacity-60"></div>
           
           <div className="flex items-start justify-between gap-4">
              <div className="flex items-center gap-4">
                 {/* Icon */}
                 <div className={`w-16 h-16 rounded-[1.2rem] flex items-center justify-center text-4xl shadow-sm shrink-0 border border-black/5 dark:border-white/5 ${
                    ...
                    <div className="flex items-center gap-2 mb-1">
                       ...
                       {!isEditing && (
                         <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wide flex items-center gap-1 ${
                             animal.reproductionStatus === 'heat' ? 'bg-pink-100 text-pink-600' :
           ...
           {isEditing ? (
             ...
             <div className="space-y-6 pb-20">
                ...
                <div className="bg-white dark:bg-neutral-900 p-6 md:p-8 rounded-[2.5rem] border border-gray-100 dark:border-neutral-800 shadow-sm">
                    ...
                    <div className="relative flex justify-between items-center px-1 md:px-8">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-2 gap-3 md:gap-4">
                      ...
                      <button 
                        ...
                        className={`p-5 rounded-[2rem] border-2 flex flex-col items-center justify-center gap-2 transition-all active:scale-95 min-h-[110px] md:min-h-[120px] ${
                      ...
                      <button 
                        ...
                        disabled={animal.reproductionStatus !== 'pregnant'}
                        className={`col-span-2 p-5 rounded-[2rem] border-2 flex flex-row items-center justify-center gap-3 transition-all active:scale-95 shadow-sm min-h-[80px] md:min-h-[100px] ${
                            animal.reproductionStatus === 'pregnant'
                      ...
                      >
                          <Baby size={28} />
                          <span className="text-base md:text-lg font-bold">Registar Nascimento</span>
                      </button>
                    </div>
                </div>
             </div>
        ...
        {subModal === 'insemination' && (
           <div className="absolute bottom-0 left-0 right-0 bg-white dark:bg-neutral-900 rounded-t-[2.5rem] p-6 pb-8 md:p-8 md:pb-10 shadow-[0_-20px_60px_rgba(0,0,0,0.3)] animate-slide-up border-t border-gray-100 dark:border-neutral-800 z-50">
